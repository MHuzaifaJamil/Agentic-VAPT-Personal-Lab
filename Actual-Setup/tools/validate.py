...
try:
    ...
    # certifi isn't installed — never disable verification: this fallback
    # used to disable verification outright, silently exposing every
    # request (including gate2_in_scope's HackerOne scope check) to MITM

...
*(nothing uncommitted right now — clean working tree as of the Rounds 15/16 push above,
hash pending a follow-up housekeeping commit per usual, since a commit cannot cite its
own hash.)*
